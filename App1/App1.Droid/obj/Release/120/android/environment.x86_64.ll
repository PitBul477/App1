; ModuleID = 'obj\Release\120\android\environment.x86_64.ll'
source_filename = "obj\Release\120\android\environment.x86_64.ll"
...
@__app_environment_variables_v_1.3 = internal constant [16 x i8] c"major=marksweep\00", align 16
@__app_environment_variables_n_2.4 = internal constant [17 x i8] c"XAMARIN_BUILD_ID\00", align 16
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"a2b9b9a2-2b13-48d4-9f10-2c0a4dad9eb9\00", align 16
...
@app_environment_variables = local_unnamed_addr constant [12 x i8*] [
	...
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__app_environment_variables_v_1.3, i32 0, i32 0),
...
@__ApplicationConfig_android_package_name.0 = internal constant [14 x i8] c"UMping.UMping\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 39, ; number_of_assemblies_in_apk
	i32 0, ; bundled_assembly_name_width
	i32 2, ; number_of_assembly_store_files
	i32 20, ; number_of_dso_cache_entries
	i32 33555300, ; android_runtime_jnienv_class_token
	i32 100673664, ; jnienv_initialize_method_token
	i32 100673663, ; jnienv_registerjninatives_method_token
	...
	i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__ApplicationConfig_android_package_name.0, i32 0, i32 0); android_package_name
}, align 8
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [39 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
